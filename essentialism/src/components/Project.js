    ...
    const textColor = '#696969';
        ...
        return (
            ...
            <Form  style={{ margin: '5%', marginLeft: '20%' }}>
              ...
              <Card style={{border: 'none', background: 'transparent', color: textColor, /* textShadow: '2px 1px 2px #000000', */ marginRight: '25%'   }}  >
              ...
              <Row>
                <Col sm="1.8">
              <Card style={{ width: '15%', display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', justifyContent: 'space-evenly',  border: 'none', background: 'transparent', color: textColor /* , textShadow: '2px 1px 2px #000000' */,  }} >
            ...
            <FormGroup check style={{ padding: '25px', width: '20%', display: 'flex', flexDirection: 'column', flexWrap: 'wrap', justifyContent: 'space-evenly', alignItems: 'flex-start', fontSize: '18px', fontWeight: 'bold' }} >
              ...
              <FormGroup style={{ width: '40%', margin: '2%', marginLeft: '22%', color: textColor, fontWeight: 'bolder'/* , textShadow: '2px 1px 2px #000000' */, fontSize: '20px' }} >
              ...
              <FormGroup row style={{ width: '60%', margin: '3%', marginLeft: '35%', color: textColor, fontWeight: 'bolder'/* , textShadow: '2px 1px 2px #000000' */, fontSize: '20px' }} >
              ...
              <Button style={{  background: '#FF6484', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)', fontWeight: 'bold' , textShadow: '2px 2px 8px #C0C0C0 ', width: '20%',margin: '1%', marginRight: '18%',   }} >Submit</Button>
